...
> gs -sDEVICE=pdfwrite -dNumRenderingThreads=4 -dPDFSETTINGS=/prepress -dNOPAUSE -dBATCH -dBufferSpace=2000000000 -sOutputFile=${EXPORT_DIR}/PhD_Thesis_600dpi.pdf ${BUILD_DIR}/main.pdf 
> gs -sDEVICE=pdfwrite -dNumRenderingThreads=4 -dPDFSETTINGS=/printer -dNOPAUSE -dBATCH -dBufferSpace=2000000000 -sOutputFile=${EXPORT_DIR}/body.pdf ${BUILD_DIR}/main.pdf
